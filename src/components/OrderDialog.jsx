  ...
  return (
    <>
      <Dialog open={isOpen} onOpenChange={onClose}>
        <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto bg-white border-gray-300 text-gray-800">
          {" "}
          {/* Dialog rangi va matn rangi yangilandi */}
          <DialogHeader>
                      ...
                      <div className="flex items-center gap-4">
                        <div className="flex items-center gap-2">
                          <Button
                            ...
                            className="h-8 w-8 bg-gray-100 border-gray-300 text-gray-800"
                          >
              ...
              <div className="space-y-3">
                <div className="relative">
                  ...
                  <Input
                    ...
                    className="pl-10 bg-gray-100 border-gray-300 text-gray-800 placeholder:text-gray-500"
                  />
                </div>
                <div className="relative">
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-2">
                <Button
                  ...
                  className="flex-1 bg-gray-100 text-gray-800 border-gray-300 hover:bg-gray-200 data-[state=active]:bg-orange-500 data-[state=active]:text-white"
                >
              ...
              <div className="relative">
                ...
                <Textarea
                  ...
                  className="pl-10 bg-gray-100 border-gray-300 text-gray-800 placeholder:text-gray-500 min-h-[80px]"
                />
              </div>
            </div>
      ...
      <AlertDialog open={showLocationAlert} onOpenChange={setShowLocationAlert}>
        <AlertDialogContent className="bg-white border-gray-300 text-gray-800">
          {" "}
          {/* Dialog rangi va matn rangi yangilandi */}
          <AlertDialogHeader>
