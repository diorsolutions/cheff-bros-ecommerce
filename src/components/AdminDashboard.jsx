...
import AdminOrderItemsDisplay from "./AdminOrderItemsDisplay"; // Yangi komponent import qilindi
                    ...
                    <CardContent className="space-y-4">
                      <div className="grid sm:grid-cols-2 gap-4 mob_small:grid-cols-1">
                        ...
                        <div>
                          ...
                          {/* Yangi AdminOrderItemsDisplay komponenti bu yerda ishlatiladi */}
                          <AdminOrderItemsDisplay 
                            items={order.items} 
